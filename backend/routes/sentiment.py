...
#Get all sentiments
@router.get("/sentiments", response_model=schemas.SentimentListResponse)
def get_sentiments(
    limit: int = 100, 
    offset: int = 0,
...
@router.get("/sentiments/filter/by-label/")
...
@router.get("/sentiments/{product_id}", response_model=schemas.SentimentListResponse)
def get_sentiment(
...
@router.get("/available-sentiment-labels")
